...
impl Hand {
    pub fn new() -> Hand {
        Hand { cards: Vec::new(), value: 0, soft: false }
    }
    ...
    fn calculate_value(&mut self) -> u8 {
        ...
        for card in &self.cards {
            ...
            if card_value > 10 {
                card_value = 10;
                if match card.rank { Rank::Ace => true, _ => false } {
                    card_value = 11;
                }
            }
    ...
    pub fn display_first_card(&self) {
        ...
        if value > 10 {
            value = 10;
            if match self.cards[0].rank { Rank::Ace => true, _ => false } {
                value = 11;
            }
        }
        println!("({}?) {}, ???\n", value.to_string(), self.cards[0].to_string());
    }
